...
/*
	Stadel.dk tilføjelse START
*/
	// Erstat <strong> med <b>
	var tmpRgx = new RegExp('(<STRONG>)|(<STRONG [^>]*>)', 'gi');
	result = result.replace(tmpRgx, '<B>');
	var tmpRgx = new RegExp('</STRONG>', 'gi');
	result = result.replace(tmpRgx, '</B>');
	
	// Erstat <span> med <font>
	/*
	var tmpRgx = new RegExp('<SPAN>', 'gi');
	result = result.replace(tmpRgx, '<FONT>');
	var tmpRgx = new RegExp('<SPAN ([^>]*)>', 'gi');
	result = result.replace(tmpRgx, '<FONT $1>');
	var tmpRgx = new RegExp('</SPAN>', 'gi');
	result = result.replace(tmpRgx, '</FONT>');
	*/
/*
	Stadel.dk tilføjelse SLUT
*/
