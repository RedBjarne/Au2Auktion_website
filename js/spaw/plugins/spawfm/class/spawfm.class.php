...
class SpawFm
{
  ...
  function renameFile($ren_old_name, $ren_new_name)
  {
    ...
    $ren_old_name = basename($ren_old_name);
              ...
              $ren_new_name = str_replace("æ", "ae", $ren_new_name);
              $ren_new_name = str_replace("ø", "oe", $ren_new_name);
              $ren_new_name = str_replace("å", "aa", $ren_new_name);
              $ren_new_name = str_replace("Æ", "Ae", $ren_new_name);
              $ren_new_name = str_replace("Ø", "Oe", $ren_new_name);
              $ren_new_name = str_replace("Å", "Aa", $ren_new_name);
			$ren_new_name = preg_replace("/[^a-zA-Z0-9_\.-]/", "_", $ren_new_name);
              ...
              $uplfile['size'] <= $this->getCurrentDirSetting('max_upload_filesize'))
          {
            ...
            */
            ...
            if (!$ok) {
              ...
              $uplfile_name = str_replace("æ", "ae", $uplfile_name);
              $uplfile_name = str_replace("ø", "oe", $uplfile_name);
              $uplfile_name = str_replace("å", "aa", $uplfile_name);
              $uplfile_name = str_replace("Æ", "Ae", $uplfile_name);
              $uplfile_name = str_replace("Ø", "Oe", $uplfile_name);
              $uplfile_name = str_replace("Å", "Aa", $uplfile_name);
              $uplfile_name = preg_replace("/[^a-zA-Z0-9_\.-]/", "_", $uplfile_name);
              $i = 1;
