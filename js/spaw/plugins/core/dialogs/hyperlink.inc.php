...
<tr id="internal_row">
  <td width="50%">Interne links:</td>
  <td width="50%" align="left">
  	<select onchange="if(this.selectedIndex>0){document.getElementById('chref').value=this.options[this.selectedIndex].value;document.getElementById('ctitle').value=this.options[this.selectedIndex].text;this.selectedIndex=0;}">
  		<option value=""></option>
		<script src="../../../Admin/?page=js_links"></script>
  	</select>
  </td>
</tr>
</table>
